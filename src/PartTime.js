...
import IconDescriptionsPT from "./parttime/IconDescriptionPT";
import PartTimeline from "./parttime/PartTimeline";
import PriceCards from "./components/PriceCards";
import SelfPacedTimeline from "./components/SelfPacedTimeline";
const { Link } = Anchor;
const { Meta } = Card;
        ...
        <div style={{ maxWidth: "1150px", margin: "auto", padding: "20px" }}>
          <div id="home">
            ...
            <p class="stay-home" style={{ textAlign: "center" }}>
              Y8Z BOOTCAMP: COMBINING the best of both worlds{" "}
            </p>
            <IconDescriptionsPT />
          </div>
